...
namespace ObjectDumping.Internal
{
    ...
    /// </summary>
    internal class ObjectDumperVisualBasic : DumperBase
    {
        public ObjectDumperVisualBasic(DumpOptions dumpOptions) : base(dumpOptions)
        {
        }
        ...
        public static string Dump(object element, DumpOptions dumpOptions = null)
        {
            ...
            var instance = new ObjectDumperVisualBasic(dumpOptions);
        ...
        private void FormatValue(object o, int intentLevel = 0)
        {
            ...
            if (o == null)
            {
                this.Write("Nothing", intentLevel);
                return;
            }
