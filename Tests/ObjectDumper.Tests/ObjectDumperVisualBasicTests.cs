...
namespace ObjectDumping.Tests
{
    ...
    public class ObjectDumperVisualBasicTests
    {
        ...
        public void ShouldExcludeProperties()
        {
            ...
            dump.Should().NotBeNull();
            dump.Should().Be("Dim testObject = new TestObject\r\n{\r\n  NullableDateTime = null\r\n};");
        }
        ...
        public void ShouldOrderProperties()
        {
            ...
            dump.Should().NotBeNull();
            dump.Should().Be("Dim orderPropertyTestObject = new OrderPropertyTestObject\r\n{\r\n  A = null,\r\n  B = null,\r\n  C = null\r\n};");
        }
        ...
        public void ShouldDumpDateTime_DateTimeKind_Utc()
        {
            ...
            this.testOutputHelper.WriteLine(dump);
            dump.Should().NotBeNull();
            dump.Should().Be("DimdateTime = DateTime.ParseExact(\"2000-01-01T23:59:59.0000000Z\", \"O\", CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind);");
        ...
        public void ShouldDumpDictionary()
        {
            ...
            this.testOutputHelper.WriteLine(dump);
            dump.Should().NotBeNull();
            dump.Should().Be("Dim dictionaryInt32String = new Dictionary<Int32, String>\r\n{\r\n  { 1, \"Value1\" },\r\n  { 2, \"Value2\" },\r\n  { 3, \"Value3\" }\r\n};");
        }
